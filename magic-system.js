...
class MagicSystem {
    constructor() {
        ...
        Object.assign(this.magicDatabase, {
            ...
            ice_lance: { id: 'ice_lance', name: 'アイスランス', emoji: '❄️', type: 'offensive', target: 'single', element: 'ice', basePower: 1, scalingStat: 'magic', mpCost: 9, requiredLevel: 3, allowedRoles: ['mage', 'all-rounder'], description: '氷の槍で敵を貫く基本術。火属性の敵に刺さる氷の単体攻撃。' },
            thunder_strike: { id: 'thunder_strike', name: 'サンダーストライク', emoji: '⚡', type: 'offensive', target: 'single', element: 'thunder', basePower: 1, scalingStat: 'magic', mpCost: 10, requiredLevel: 5, allowedRoles: ['mage', 'all-rounder'], description: '雷を落とす基本術。機械系・水濡れの敵に強い雷属性の単体攻撃。' },
            ...
            explosion: { id: 'explosion', name: 'エクスプロージョン', emoji: '💥', type: 'offensive', target: 'all', element: 'fire', basePower: 1, scalingStat: 'magic', mpCost: 26, requiredLevel: 28, allowedRoles: ['mage', 'all-rounder'], description: '大爆発で全体を焼く高威力AoE。火弱点が混じる群れに最大効率。' },
