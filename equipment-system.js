...
class EquipmentSystem {
    constructor() {
        ...
        Object.assign(this.equipmentDatabase, {
            ...
            deus_executioner: { id: 'deus_executioner', name: 'デウス・エクスキューショナー', emoji: '⚔️', type: 'weapon', slot: 'weapon', allowedRoles: ['all-rounder', 'tank'], attack: 165, defense: 12, magic: 0, magicDefense: 10, hp: 40, mp: 0, speed: 6, price: 0, sellPrice: 13000, requiredLevel: 40, description: 'デウス・エクスキューショナー（tier9）' },
