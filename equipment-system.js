...
class EquipmentSystem {
    constructor() {
        ...
        Object.assign(this.equipmentDatabase, {
            ...
            railgun_lance: { id: 'railgun_lance', name: 'レールガンランス', emoji: '⚔️', type: 'weapon', slot: 'weapon', allowedRoles: ['all-rounder', 'tank'], attack: 70, defense: 5, magic: 0, magicDefense: 0, hp: 0, mp: 0, speed: 4, price: 5200, sellPrice: 2600, requiredLevel: 13, description: 'レールガンランス（tier6）' },
            titan_cleaver: { id: 'titan_cleaver', name: 'タイタンクリーバー', emoji: '⚔️', type: 'weapon', slot: 'weapon', allowedRoles: ['all-rounder', 'tank'], attack: 95, defense: 8, magic: 0, magicDefense: 0, hp: 20, mp: 0, speed: 2, price: 8800, sellPrice: 4400, requiredLevel: 20, description: 'タイタンクリーバー（tier7）' },
            ragnarok_edge: { id: 'ragnarok_edge', name: 'ラグナロクエッジ', emoji: '⚔️', type: 'weapon', slot: 'weapon', allowedRoles: ['all-rounder', 'tank'], attack: 125, defense: 10, magic: 0, magicDefense: 0, hp: 20, mp: 0, speed: 5, price: 15000, sellPrice: 7500, requiredLevel: 30, description: 'ラグナロクエッジ（tier8）' },
            deus_executioner: { id: 'deus_executioner', name: 'デウス・エクスキューショナー', emoji: '⚔️', type: 'weapon', slot: 'weapon', allowedRoles: ['all-rounder', 'tank'], attack: 165, defense: 12, magic: 0, magicDefense: 10, hp: 40, mp: 0, speed: 6, price: 26000, sellPrice: 13000, requiredLevel: 40, description: 'デウス・エクスキューショナー（tier9）' },
            ...
            titan_armor: { id: 'titan_armor', name: 'タイタンアーマー', emoji: '🥼', type: 'body', slot: 'body', allowedRoles: ['all-rounder', 'tank'], attack: 0, defense: 44, magic: 0, magicDefense: 13, hp: 100, mp: 0, speed: -1, price: 3200, sellPrice: 1600, requiredLevel: 11, description: 'タイタンアーマー（tier5）' },
            aegis_frame: { id: 'aegis_frame', name: 'イージスフレーム', emoji: '🥼', type: 'body', slot: 'body', allowedRoles: ['all-rounder', 'tank'], attack: 0, defense: 62, magic: 0, magicDefense: 18, hp: 140, mp: 0, speed: -1, price: 5600, sellPrice: 2800, requiredLevel: 13, description: 'イージスフレーム（tier6）' },
            fortress_mail: { id: 'fortress_mail', name: 'フォートレスメイル', emoji: '🥼', type: 'body', slot: 'body', allowedRoles: ['all-rounder', 'tank'], attack: 0, defense: 84, magic: 0, magicDefense: 24, hp: 190, mp: 0, speed: -2, price: 9500, sellPrice: 4750, requiredLevel: 20, description: 'フォートレスメイル（tier7）' },
            colossus_plate: { id: 'colossus_plate', name: 'コロッサスプレート', emoji: '🥼', type: 'body', slot: 'body', allowedRoles: ['all-rounder', 'tank'], attack: 0, defense: 110, magic: 0, magicDefense: 30, hp: 250, mp: 0, speed: -2, price: 16000, sellPrice: 8000, requiredLevel: 30, description: 'コロッサスプレート（tier8）' },
            deus_bulwark: { id: 'deus_bulwark', name: 'デウス・バルワーク', emoji: '🥼', type: 'body', slot: 'body', allowedRoles: ['all-rounder', 'tank'], attack: 5, defense: 145, magic: 0, magicDefense: 40, hp: 320, mp: 0, speed: -1, price: 28000, sellPrice: 14000, requiredLevel: 40, description: 'デウス・バルワーク（tier9）' },
            ...
            titan_helm: { id: 'titan_helm', name: 'タイタンヘルム', emoji: '⛑️', type: 'head', slot: 'head', allowedRoles: ['all-rounder', 'tank'], attack: 0, defense: 32, magic: 0, magicDefense: 10, hp: 60, mp: 0, speed: 0, price: 2200, sellPrice: 1100, requiredLevel: 11, description: 'タイタンヘルム（tier5）' },
            aegis_helm: { id: 'aegis_helm', name: 'イージスヘルム', emoji: '⛑️', type: 'head', slot: 'head', allowedRoles: ['all-rounder', 'tank'], attack: 0, defense: 44, magic: 0, magicDefense: 14, hp: 85, mp: 0, speed: 0, price: 3900, sellPrice: 1950, requiredLevel: 13, description: 'イージスヘルム（tier6）' },
            fortress_helm: { id: 'fortress_helm', name: 'フォートレスヘルム', emoji: '⛑️', type: 'head', slot: 'head', allowedRoles: ['all-rounder', 'tank'], attack: 0, defense: 58, magic: 0, magicDefense: 18, hp: 115, mp: 0, speed: 0, price: 6800, sellPrice: 3400, requiredLevel: 20, description: 'フォートレスヘルム（tier7）' },
            deus_crown: { id: 'deus_crown', name: 'デウス・クラウン', emoji: '⛑️', type: 'head', slot: 'head', allowedRoles: ['all-rounder', 'tank'], attack: 0, defense: 78, magic: 0, magicDefense: 24, hp: 160, mp: 0, speed: 1, price: 12500, sellPrice: 6250, requiredLevel: 30, description: 'デウス・クラウン（tier8）' },
            ...
            titan_fists: { id: 'titan_fists', name: 'タイタンフィスト', emoji: '🧤', type: 'hands', slot: 'hands', allowedRoles: ['all-rounder', 'tank'], attack: 17, defense: 27, magic: 0, magicDefense: 7, hp: 15, mp: 0, speed: 1, price: 2100, sellPrice: 1050, requiredLevel: 11, description: 'タイタンフィスト（tier5）' },
            aegis_gauntlets: { id: 'aegis_gauntlets', name: 'イージスガントレット', emoji: '🧤', type: 'hands', slot: 'hands', allowedRoles: ['all-rounder', 'tank'], attack: 24, defense: 38, magic: 0, magicDefense: 10, hp: 25, mp: 0, speed: 2, price: 3700, sellPrice: 1850, requiredLevel: 13, description: 'イージスガントレット（tier6）' },
            fortress_gauntlets: { id: 'fortress_gauntlets', name: 'フォートレスガントレット', emoji: '🧤', type: 'hands', slot: 'hands', allowedRoles: ['all-rounder', 'tank'], attack: 33, defense: 52, magic: 0, magicDefense: 14, hp: 40, mp: 0, speed: 2, price: 6500, sellPrice: 3250, requiredLevel: 20, description: 'フォートレスガントレット（tier7）' },
            deus_gauntlets: { id: 'deus_gauntlets', name: 'デウス・ガントレット', emoji: '🧤', type: 'hands', slot: 'hands', allowedRoles: ['all-rounder', 'tank'], attack: 45, defense: 70, magic: 0, magicDefense: 18, hp: 60, mp: 0, speed: 3, price: 11800, sellPrice: 5900, requiredLevel: 30, description: 'デウス・ガントレット（tier8）' },
            berserker_band: { id: 'berserker_band', name: 'バーサーカーバンド', emoji: '💍', type: 'accessory', slot: 'accessory', allowedRoles: ['all-rounder', 'tank'], attack: 14, defense: 2, magic: 0, magicDefense: 0, hp: 0, mp: 0, speed: 3, price: 1600, sellPrice: 800, requiredLevel: 8, description: 'バーサーカーバンド（tier4）' },
            iron_will_pendant: { id: 'iron_will_pendant', name: 'アイアンウィルペンダント', emoji: '💍', type: 'accessory', slot: 'accessory', allowedRoles: ['all-rounder', 'tank'], attack: 2, defense: 14, magic: 0, magicDefense: 8, hp: 60, mp: 0, speed: 0, price: 1600, sellPrice: 800, requiredLevel: 8, description: 'アイアンウィルペンダント（tier4）' },
            warlord_emblem: { id: 'warlord_emblem', name: 'ウォーロードエンブレム', emoji: '💍', type: 'accessory', slot: 'accessory', allowedRoles: ['all-rounder', 'tank'], attack: 28, defense: 6, magic: 0, magicDefense: 4, hp: 40, mp: 0, speed: 5, price: 4400, sellPrice: 2200, requiredLevel: 13, description: 'ウォーロードエンブレム（tier6）' },
            bastion_core: { id: 'bastion_core', name: 'バスティオンコア', emoji: '💍', type: 'accessory', slot: 'accessory', allowedRoles: ['all-rounder', 'tank'], attack: 6, defense: 30, magic: 0, magicDefense: 16, hp: 120, mp: 0, speed: 0, price: 4400, sellPrice: 2200, requiredLevel: 13, description: 'バスティオンコア（tier6）' },
            deus_sigil: { id: 'deus_sigil', name: 'デウス・シジル', emoji: '💍', type: 'accessory', slot: 'accessory', allowedRoles: ['all-rounder', 'tank'], attack: 40, defense: 40, magic: 0, magicDefense: 22, hp: 150, mp: 0, speed: 6, price: 22000, sellPrice: 11000, requiredLevel: 40, description: 'デウス・シジル（tier9）' },
            apprentice_staff: { id: 'apprentice_staff', name: '見習いの杖', emoji: '🪄', type: 'weapon', slot: 'weapon', allowedRoles: ['all-rounder', 'mage'], attack: 3, defense: 0, magic: 6, magicDefense: 0, hp: 0, mp: 6, speed: 0, price: 300, sellPrice: 150, requiredLevel: 1, description: '見習いの杖（tier1）' },
            acolyte_rod: { id: 'acolyte_rod', name: '信徒のロッド', emoji: '🪄', type: 'weapon', slot: 'weapon', allowedRoles: ['all-rounder', 'healer'], attack: 2, defense: 0, magic: 6, magicDefense: 0, hp: 0, mp: 8, speed: 0, price: 300, sellPrice: 150, requiredLevel: 1, description: '信徒のロッド（tier1）' },
            ...
            oak_staff: { id: 'oak_staff', name: '樫の杖', emoji: '🪄', type: 'weapon', slot: 'weapon', allowedRoles: ['all-rounder', 'mage'], attack: 4, defense: 0, magic: 9, magicDefense: 0, hp: 0, mp: 10, speed: 0, price: 650, sellPrice: 325, requiredLevel: 3, description: '樫の杖（tier2）' },
            prayer_rod: { id: 'prayer_rod', name: '祈りのロッド', emoji: '🪄', type: 'weapon', slot: 'weapon', allowedRoles: ['all-rounder', 'healer'], attack: 3, defense: 0, magic: 9, magicDefense: 0, hp: 0, mp: 12, speed: 0, price: 650, sellPrice: 325, requiredLevel: 3, description: '祈りのロッド（tier2）' },
            ...
            rune_staff: { id: 'rune_staff', name: 'ルーンの杖', emoji: '🪄', type: 'weapon', slot: 'weapon', allowedRoles: ['all-rounder', 'mage'], attack: 6, defense: 0, magic: 13, magicDefense: 0, hp: 0, mp: 15, speed: 0, price: 1300, sellPrice: 650, requiredLevel: 5, description: 'ルーンの杖（tier3）' },
            saint_rod: { id: 'saint_rod', name: '聖者のロッド', emoji: '🪄', type: 'weapon', slot: 'weapon', allowedRoles: ['all-rounder', 'healer'], attack: 4, defense: 0, magic: 13, magicDefense: 0, hp: 0, mp: 18, speed: 0, price: 1300, sellPrice: 650, requiredLevel: 5, description: '聖者のロッド（tier3）' },
            ...
            sorcerer_staff: { id: 'sorcerer_staff', name: '魔術師の杖', emoji: '🪄', type: 'weapon', slot: 'weapon', allowedRoles: ['all-rounder', 'mage'], attack: 8, defense: 0, magic: 19, magicDefense: 0, hp: 0, mp: 22, speed: 0, price: 2400, sellPrice: 1200, requiredLevel: 8, description: '魔術師の杖（tier4）' },
            cleric_rod: { id: 'cleric_rod', name: '司祭のロッド', emoji: '🪄', type: 'weapon', slot: 'weapon', allowedRoles: ['all-rounder', 'healer'], attack: 5, defense: 0, magic: 19, magicDefense: 0, hp: 0, mp: 26, speed: 0, price: 2400, sellPrice: 1200, requiredLevel: 8, description: '司祭のロッド（tier4）' },
            ...
            archmage_staff: { id: 'archmage_staff', name: '大魔術師の杖', emoji: '🪄', type: 'weapon', slot: 'weapon', allowedRoles: ['all-rounder', 'mage'], attack: 11, defense: 0, magic: 27, magicDefense: 0, hp: 0, mp: 32, speed: 0, price: 4200, sellPrice: 2100, requiredLevel: 11, description: '大魔術師の杖（tier5）' },
            bishop_rod: { id: 'bishop_rod', name: '司教のロッド', emoji: '🪄', type: 'weapon', slot: 'weapon', allowedRoles: ['all-rounder', 'healer'], attack: 7, defense: 0, magic: 27, magicDefense: 0, hp: 0, mp: 36, speed: 0, price: 4200, sellPrice: 2100, requiredLevel: 11, description: '司教のロッド（tier5）' },
            ...
            warlock_staff: { id: 'warlock_staff', name: '破魔の杖', emoji: '🪄', type: 'weapon', slot: 'weapon', allowedRoles: ['all-rounder', 'mage'], attack: 15, defense: 0, magic: 38, magicDefense: 0, hp: 0, mp: 46, speed: 0, price: 7000, sellPrice: 3500, requiredLevel: 13, description: '破魔の杖（tier6）' },
            cardinal_rod: { id: 'cardinal_rod', name: '枢機のロッド', emoji: '🪄', type: 'weapon', slot: 'weapon', allowedRoles: ['all-rounder', 'healer'], attack: 10, defense: 0, magic: 38, magicDefense: 0, hp: 0, mp: 50, speed: 0, price: 7000, sellPrice: 3500, requiredLevel: 13, description: '枢機のロッド（tier6）' },
            void_robe: { id: 'void_robe', name: '虚空のローブ', emoji: '🧥', type: 'body', slot: 'body', allowedRoles: ['all-rounder', 'healer', 'mage'], attack: 0, defense: 15, magic: 18, magicDefense: 19, hp: 0, mp: 66, speed: 0, price: 5800, sellPrice: 2900, requiredLevel: 13, description: '虚空のローブ（tier6）' },
            eclipse_orb: { id: 'eclipse_orb', name: '蝕のオーブ', emoji: '🔮', type: 'accessory', slot: 'accessory', allowedRoles: ['all-rounder', 'healer', 'mage'], attack: 0, defense: 0, magic: 13, magicDefense: 14, hp: 0, mp: 50, speed: 3, price: 5000, sellPrice: 2500, requiredLevel: 13, description: '蝕のオーブ（tier6）' },
            sage_lord_staff: { id: 'sage_lord_staff', name: '賢王の杖', emoji: '🪄', type: 'weapon', slot: 'weapon', allowedRoles: ['all-rounder', 'mage'], attack: 20, defense: 0, magic: 53, magicDefense: 0, hp: 0, mp: 64, speed: 0, price: 11500, sellPrice: 5750, requiredLevel: 20, description: '賢王の杖（tier7）' },
            seraph_rod: { id: 'seraph_rod', name: '熾天使のロッド', emoji: '🪄', type: 'weapon', slot: 'weapon', allowedRoles: ['all-rounder', 'healer'], attack: 13, defense: 0, magic: 53, magicDefense: 0, hp: 0, mp: 68, speed: 0, price: 11500, sellPrice: 5750, requiredLevel: 20, description: '熾天使のロッド（tier7）' },
            celestial_robe: { id: 'celestial_robe', name: '天界のローブ', emoji: '🧥', type: 'body', slot: 'body', allowedRoles: ['all-rounder', 'healer', 'mage'], attack: 0, defense: 20, magic: 25, magicDefense: 26, hp: 0, mp: 90, speed: 0, price: 9500, sellPrice: 4750, requiredLevel: 20, description: '天界のローブ（tier7）' },
            galaxy_orb: { id: 'galaxy_orb', name: '銀河のオーブ', emoji: '🔮', type: 'accessory', slot: 'accessory', allowedRoles: ['all-rounder', 'healer', 'mage'], attack: 0, defense: 0, magic: 18, magicDefense: 19, hp: 0, mp: 68, speed: 4, price: 8200, sellPrice: 4100, requiredLevel: 20, description: '銀河のオーブ（tier7）' },
            deus_staff: { id: 'deus_staff', name: '神理の杖', emoji: '🪄', type: 'weapon', slot: 'weapon', allowedRoles: ['all-rounder', 'mage'], attack: 26, defense: 0, magic: 72, magicDefense: 0, hp: 0, mp: 88, speed: 0, price: 18000, sellPrice: 9000, requiredLevel: 30, description: '神理の杖（tier8）' },
            divine_rod: { id: 'divine_rod', name: '神癒のロッド', emoji: '🪄', type: 'weapon', slot: 'weapon', allowedRoles: ['all-rounder', 'healer'], attack: 17, defense: 0, magic: 72, magicDefense: 0, hp: 0, mp: 92, speed: 0, price: 18000, sellPrice: 9000, requiredLevel: 30, description: '神癒のロッド（tier8）' },
            empyrean_robe: { id: 'empyrean_robe', name: '天威のローブ', emoji: '🧥', type: 'body', slot: 'body', allowedRoles: ['all-rounder', 'healer', 'mage'], attack: 0, defense: 26, magic: 34, magicDefense: 35, hp: 0, mp: 120, speed: 0, price: 15000, sellPrice: 7500, requiredLevel: 30, description: '天威のローブ（tier8）' },
            cosmos_orb: { id: 'cosmos_orb', name: '宇宙のオーブ', emoji: '🔮', type: 'accessory', slot: 'accessory', allowedRoles: ['all-rounder', 'healer', 'mage'], attack: 0, defense: 0, magic: 24, magicDefense: 26, hp: 0, mp: 92, speed: 4, price: 13000, sellPrice: 6500, requiredLevel: 30, description: '宇宙のオーブ（tier8）' },
            kamui_staff: { id: 'kamui_staff', name: '神威の杖', emoji: '🪄', type: 'weapon', slot: 'weapon', allowedRoles: ['all-rounder', 'mage'], attack: 35, defense: 0, magic: 98, magicDefense: 0, hp: 0, mp: 120, speed: 0, price: 30000, sellPrice: 15000, requiredLevel: 40, description: '神威の杖（tier9）' },
            kamui_rod: { id: 'kamui_rod', name: '神威のロッド', emoji: '🪄', type: 'weapon', slot: 'weapon', allowedRoles: ['all-rounder', 'healer'], attack: 23, defense: 0, magic: 98, magicDefense: 0, hp: 0, mp: 124, speed: 0, price: 30000, sellPrice: 15000, requiredLevel: 40, description: '神威のロッド（tier9）' },
            kamui_robe: { id: 'kamui_robe', name: '神威のローブ', emoji: '🧥', type: 'body', slot: 'body', allowedRoles: ['all-rounder', 'healer', 'mage'], attack: 0, defense: 34, magic: 46, magicDefense: 48, hp: 0, mp: 160, speed: 0, price: 25000, sellPrice: 12500, requiredLevel: 40, description: '神威のローブ（tier9）' },
            kamui_orb: { id: 'kamui_orb', name: '神威のオーブ', emoji: '🔮', type: 'accessory', slot: 'accessory', allowedRoles: ['all-rounder', 'healer', 'mage'], attack: 0, defense: 0, magic: 33, magicDefense: 36, hp: 0, mp: 124, speed: 5, price: 21000, sellPrice: 10500, requiredLevel: 40, description: '神威のオーブ（tier9）' }
        });
